...
class BioAssayAnalysisDataTea implements IExcelProfile {
    ...
    def static getTop50AnalysisDataForAnalysis(Long analysisId) {
        def query = "SELECT DISTINCT baad FROM org.transmart.biomart.BioAssayAnalysisDataTea baad WHERE baad.analysis.id =:aid and baad.teaRank<=50 ORDER BY baad.teaRank DESC";
