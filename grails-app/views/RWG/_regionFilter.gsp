<g:unless test="${forDatasetExplorer}">
...
Gene/RSID: <tmpl:/RWG/extSearchField width="200" fieldName="filterGeneId" searchAction="searchAutoComplete" searchController="RWG" />
...
<div onclick="jQuery('[name=\'regionFilter\'][value=\'chromosome\']').attr('checked', true);">
	...
	<g:select name="filterChromosomeRange" from="${ranges}" optionKey="${{it.key}}" optionValue="${{it.value}}"/> <g:textField name="filterChromosomeBasePairs" style="width: 50px"/> base pairs
</div>

<g:if test="${forDatasetExplorer}">
	<br/>
	<hr/>
	<br/>
	
	<div><b>Inclusion criteria:</b>
		<span style="width:16px; display: inline-block">&nbsp;</span>
		<g:radio id="filterInclusionCriteriaMutant" name="filterInclusionCriteria" value="mutant" checked="checked"/> Mutant
		<span style="width:16px; display: inline-block">&nbsp;</span>
		<g:radio id="filterInclusionCriteriaWildType" name="filterInclusionCriteria" value="wildtype"/> Wild type
	</div>
</g:if>