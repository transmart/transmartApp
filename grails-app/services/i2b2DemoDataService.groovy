...
class i2b2DemoDataService {
	...
	def createQueryRecords(resultInstanceId, requestXML)
	{
		...
		sqlObject.execute("INSERT INTO QT_QUERY_INSTANCE (QUERY_INSTANCE_ID, QUERY_MASTER_ID, USER_ID, GROUP_ID, START_DATE) VALUES (?,?,'DEMO','DEMO', sysdate)", [queryInstanceId.NEXTVAL, queryMasterId.NEXTVAL])
