...
<html>
	...
	<body>
		<div id="header-div">
			...
			<div id="formPage1" style="background-color: #EEE; display: none;">
			...
			<div id="formPage2" style="background-color: #EEE">
			...
			<div class="dataFormTitle" id="dataFormTitle2">Upload Data</div>
				...
				<table class="uploadTable">
					<tr>
						...
						<td colspan="3">
								<i>This data set is PENDING - the file cannot be changed.</i>
							<br/>
				...
				<div class="buttonbar">
					...
					<g:actionSubmit class="upload" value="Continue" action="skipp"/>
					<a class="button" href="${createLink([action:'index',controller:'uploadData'])}">Cancel</a>
				</div>
			</div>
