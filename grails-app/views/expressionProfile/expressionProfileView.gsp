...
<div id="expr_profile_main_div" style="display: block;" class="body">
    <table>
        ...
        <g:if test="${epr.genes.size >= grailsApplication.config.com.recomdata.search.gene.max}">
            <tr><td style="color: red; font-weight: bold;">More than ${grailsApplication.config.com.recomdata.search.gene.max} genes detected, please refine search to see extra detail!</td>
            </tr>
        </g:if>
        ...
        <tr>
            <td>
                <table class="jubfilter">
                    <tr><th>Filter (Note: search found ${epr.profCount} studies)</th>
                    </tr>
                    <tr>
                        <td>
                            <table class="jubfiltersection">
                                ...
                                <tr>
                                    <td>Disease:</td>
                                    <td>
                                        <g:select from="${epr.diseases}"
                                                  name="bioDiseaseId"
                                                  optionKey="id"
                                                  optionValue="preferredName"
        ...
        <tr>
            <td>
                ...
                <div id="expr_profile_graph_div"
                     style="display: block;"><g:render template="graphView"
                                                       model="graphURL:graphURL"/></div>
            </td>
        </tr>
        ...
        <tr>
            <td><br/>
                Data courtesy of <a
                    style="font-weight: bold; line-height: 13px;"
