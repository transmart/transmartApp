...
public class GeneSignatureService {
            ...
            while (br.ready()) {
                ...
                if (fileSchemaName.toUpperCase() =~ /GENE /) {
                 ...
                 // fix -- 2014_10_31
                    ...
                    marker = lookupProbesetBioAssociations_fix(geneSymbol, gs.techPlatform.accession) // fix -- 2014_10_31
    ...
    /**
     * fixed by WaveAccess -- 2014.10.31 -- probeset signatues
     * match up the uploaded probeset id with our internal bio_assay_feature_group & bio_data_uid tables
     */
    def lookupProbesetBioAssociations_fix(String probeset, String platform) {
        def query = new Query(mainTableAlias: "bf");
