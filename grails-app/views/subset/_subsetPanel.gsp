        ...
        <g:each var="currentGroup" in="${(1..20).toList()}">
            <tr id="qcr${currentGroup}">
                <td align="right">
                    ...
                    <button id="btnPanelTimingGroup1_${currentGroup}" style="font:9pt tahoma;display:none;"
                            onclick="timingGroup(this, '1', '${currentGroup}')">Independent</button>
                    <button id="btnExcludeGroup1_${currentGroup}" style="font:9pt tahoma;"
                            onclick="excludeGroup(this, '1', '${currentGroup}')">Exclude</button>
                    <button id="clearGroup1_${currentGroup}" style="font:9pt tahoma;"
                            onclick="clearGroup('1', '${currentGroup}')">X</button>
                    <br>
                ...
                <td align="right">
                    ...
                    <button id="btnPanelTimingGroup2_${currentGroup}" style="font:9pt tahoma;display:none;"
                            onclick="timingGroup(this, '2', '${currentGroup}')">Independent</button>
                    <button id="btnExcludeGroup2_${currentGroup}" style="font:9pt tahoma;"
                            onclick="excludeGroup(this, '2', '${currentGroup}')">Exclude</button>
                    <button id="clearGroup2_${currentGroup}" style="font:9pt tahoma;"
                            onclick="clearGroup('2', '${currentGroup}')">X</button>
                    <br>
