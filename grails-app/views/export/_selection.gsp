    ...
    <table class="baseGrid">
      ...
      <g:each in="${layout}" status="i" var="layoutRow">
            <tr>
                ...
                <g:else>
                     <g:textArea size="100" cols="74" rows="5" name="${layoutRow.column}" value="${fieldValue(bean:folder,field:layoutRow.column)}" />          
                </g:else>
                </td>                
            </tr>
        </g:each>  
...
<div></div>
<div class="buttons">
    <span class="button"><g:actionSubmit class="save" action="export" id="Export" value="${message(code: 'default.button.update.label', default: 'Export')}" /></span>
    <span class="button"><g:actionSubmit class="cancel" action="clear" id="Clear" value="${message(code: 'default.button.update.label', default: 'Clear Cart')}" /></span>
