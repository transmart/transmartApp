...
class SavedFacetedSearch {
  	 ...
  	 Long id
	 Long userId   // would like to reference the org.transmart.searchapp.AuthUser class, but can't because it is in default package -- for now just reference the id until we move to Grails 2
	 String name
	 String description
	 String criteria
