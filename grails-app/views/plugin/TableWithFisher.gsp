	...
	<form>
		...
		<div id="divBinning" style="display:none;">
			...
			<table id="tblBinningTable" class="subsettable" border="0px" style="margin: 10px; width: 90%;">
				<tr>		
					<td>
						<h2><u>Dependent Variable</u></h2>
					</td>
					<td id="subsetdivider" rowspan="7" valign="center" align="center" height="100%">
						<div style="margin: 15px; border: 1px solid black; background: black; width: 1px; height: 150px"></div>
					</td>
					<td>
						<h2><u>Independent Variable</u></h2>
					</td>										
				</tr>
				<tr>		
					<td>
				...
				<tr>
					...
					<td>
						<b>Manual Binning</b> : <input type="checkbox" onClick="Ext.get('divManualBin2').toggle();" />
					</td>					
				</tr>			
				<tr>
					<td>
					...
					<td>
						<div id="divManualBin2" style="display:none;">
