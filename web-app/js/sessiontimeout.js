...
function addTimeoutDialog(heartbeatURL, logoutURL)	{
    ...
    jQuery.idleTimeout('#timeout-div', 'div.ui-dialog-buttonpane button:first', {
    	idleAfter: 1500,	 				// user is considered idle after 25 minutes of no movement
        pollingInterval: 600,  				// how often we check for heartbeat (10 minutes) to ensure the server session does not timeout
