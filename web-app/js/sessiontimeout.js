...
function addTimeoutDialog(o)	{
    ...
    jQuery.idleTimeout('#timeout-div', 'div.ui-dialog-buttonpane button:first', {
    	idleAfter: o.sessionTimeout,	 	// user is considered idle after 25 minutes of no movement (1500 seconds)
        pollingInterval: o.heartbeatLaps,  	// how often we check for heartbeat (5 minutes - 300 seconds) to ensure the server session does not timeout
        keepAliveURL: o.heartbeatURL,		// this URL will respond with the text shown below
        serverResponseEquals: 'ALIVE',  	// the response from heartbeat must equal this text
        onTimeout: function(){
        	window.location = o.logoutURL;	// redirect the user when they timeout.
        },
        onIdle: function()	{
